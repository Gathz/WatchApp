const tmdbDiscover="tv",API_KEY="api_key=59a196db85cf15d1d2d05b1fd481f431&language=it-IT&region=IT&include_adult=true",BASE_URL="https://api.themoviedb.org/3",API_URL=BASE_URL+"/discover/"+tmdbDiscover+"?latest&"+API_KEY,IMG_URL="https://image.tmdb.org/t/p/w500",searchURL=BASE_URL+"/search/"+tmdbDiscover+"?"+API_KEY,genres=[{id:28,name:"Azione"},{id:12,name:"Avventura"},{id:16,name:"Animazione"},{id:35,name:"Commedia"},{id:80,name:"Crime"},{id:99,name:"Documentario"},{id:18,name:"Dramma"},{id:10751,name:"Famiglia"},{id:14,name:"Fantasy"},{id:36,name:"Storia"},{id:27,name:"Horror"},{id:10402,name:"Musica"},{id:9648,name:"Mistero"},{id:10749,name:"Romance"},{id:878,name:"Fantascienza"},{id:10770,name:"TV Movie"},{id:53,name:"Thriller"},{id:10752,name:"Guerra"},{id:37,name:"Western"}],scrolltToView=document.getElementById("containerToWatch"),main=document.getElementById("main"),formSearchFilter=document.getElementById("formSearchFilter"),search=document.getElementById("searchFilter"),tagsEl=document.getElementById("tags"),prev=document.getElementById("prev"),next=document.getElementById("next"),current=document.getElementById("current");var currentPage=1,nextPage=2,prevPage=3,lastUrl="",totalPages=100,selectedGenre=[];function setGenre(){tagsEl.innerHTML="",genres.forEach(a=>{const e=document.createElement("div");e.classList.add("tag"),e.id=a.id,e.innerText=a.name,e.addEventListener("click",()=>{0!=selectedGenre.length&&selectedGenre.includes(a.id)?selectedGenre.forEach((e,t)=>{e==a.id&&selectedGenre.splice(t,1)}):selectedGenre.push(a.id),getMovies(API_URL+"&with_genres="+encodeURI(selectedGenre.join(","))),highlightSelection()}),tagsEl.append(e)})}function highlightSelection(){const e=document.querySelectorAll(".tag");e.forEach(e=>{e.classList.remove("highlight")}),clearBtn(),$("#btnRetrieve_watchlist").click(),$("#btnRetrieve_watched").click(),0!=selectedGenre.length&&selectedGenre.forEach(e=>{const t=document.getElementById(e);t.classList.add("highlight"),$("#filterBtn").addClass("hasFilter")})}function clearBtn(){let e=document.getElementById("clear");if(e)e.classList.add("highlight");else{let e=document.createElement("div");e.classList.add("tag","highlight"),e.id="clear",e.innerText="Clear x",e.addEventListener("click",()=>{selectedGenre=[],setGenre(),getMovies(API_URL),$("#btnRetrieve_watchlist").click(),$("#btnRetrieve_watched").click(),$("#filterBtn").removeClass("hasFilter")}),tagsEl.append(e)}}function getMovies(e){lastUrl=e,fetch(e).then(e=>e.json()).then(e=>{0!==e.results.length?(showMovies(e.results),currentPage=e.page,nextPage=currentPage+1,prevPage=currentPage-1,totalPages=e.total_pages,(current.innerText=currentPage)<=1?(prev.classList.add("disabled"),next.classList.remove("disabled")):totalPages<=currentPage?(prev.classList.remove("disabled"),next.classList.add("disabled")):(prev.classList.remove("disabled"),next.classList.remove("disabled")),scrolltToView.scrollIntoView({behavior:"smooth"})):main.innerHTML='<h1 class="no-results">No Results Found</h1>'})}function showMovies(e){main.innerHTML="",e.forEach(e=>{var{name:t,poster_path:a,id:e}=e;const l=document.createElement("div");l.classList.add("mainWrapper","col-6","col-md-4","col-lg-3","col-xl-2"),l.innerHTML=`
        ...
        `,main.appendChild(l)}),$(".movieImg").load(function(){$(this).parent().parent(".skeleton").removeClass("skeleton")})}function pageCall(e){let t=lastUrl.split("?"),a=t[1].split("&"),l=a[a.length-1].split("=");"page"!=l[0]?getMovies(lastUrl+"&page="+e):(l[1]=e.toString(),e=l.join("="),a[a.length-1]=e,e=a.join("&"),getMovies(t[0]+"?"+e))}setGenre(),getMovies(API_URL),formSearchFilter.addEventListener("submit",e=>{e.preventDefault();e=search.value;selectedGenre=[],setGenre(),e?(getMovies(searchURL+"&query="+e),$("#btnRetrieve_watchlist").click(),$("#btnRetrieve_watched").click(),$("#clearFilter").addClass("show")):(getMovies(API_URL),$("#btnRetrieve_watchlist").click(),$("#btnRetrieve_watched").click(),$("#clearFilter").removeClass("show"))}),$("#clearFilter").click(function(){$("#searchFilter").val(""),getMovies(API_URL),$("#btnRetrieve_watchlist").click(),$("#btnRetrieve_watched").click(),$(this).removeClass("show")}),prev.addEventListener("click",()=>{0<prevPage&&(pageCall(prevPage),$("#btnRetrieve_watchlist").click(),$("#btnRetrieve_watched").click())}),next.addEventListener("click",()=>{nextPage<=totalPages&&(pageCall(nextPage),$("#btnRetrieve_watchlist").click(),$("#btnRetrieve_watched").click())}),$("#filterBtn").click(function(){MicroModal.show("modalTags")}),$("#modalTags-close").click(function(){MicroModal.close("modalTags")});var request,APP_URL="";function getStorageAPI(){localStorage.getItem("api_serie");(APP_URL=localStorage.getItem("api_serie"))&&$("#logout").css("display","")}function recordEdit(e){MicroModal.show("modalWatchlist"),$("#modalWatchlist-close").click(function(){MicroModal.close("modalWatchlist")}),resetForm();var t=[];$(e).closest(".wrapper").find("div").each(function(){t.push($(this).text())}),$("#formCreate_watchlist #tid").val(t[0]),$("#formCreate_watchlist #movie_id").val(t[1]),$("#formCreate_watchlist #title").val(t[2]),$("#formCreate_watchlist #poster_path").val(t[3]),$("#formCreate_watchlist #watched").val(t[4]),$("#formCreate_watchlist #link").val(t[5]),$("#formCreate_watchlist #season").val(t[6]),$("#formCreate_watchlist #episode").val(t[7]),$("#formCreate_watched #tid_watched").val(t[0]),$("#formCreate_watched #movie_id_watched").val(t[1]),$("#formCreate_watched #title_watched").val(t[2]),$("#formCreate_watched #poster_path_watched").val(t[3]),$("#formCreate_watched #watched_watched").val(t[4]),$("#formCreate_watched #link_watched").val(t[5]),$("#formCreate_watched #season_watched").val(t[6]),$("#formCreate_watched #episode_watched").val(t[7]),$("#formCreate_rewatch #tid_rewatch").val(t[0]),$("#formCreate_rewatch #movie_id_rewatch").val(t[1]),$("#formCreate_rewatch #title_rewatch").val(t[2]),$("#formCreate_rewatch #poster_path_rewatch").val(t[3]),$("#formCreate_rewatch #watched_rewatch").val(t[4]),$("#formCreate_rewatch #link_rewatch").val(t[5]),$("#formCreate_rewatch #season_rewatch").val(t[6]),$("#formCreate_rewatch #episode_rewatch").val(t[7]),$("#modalWatchlist-title").text(t[2])}function resetForm(){$("#formCreate_watchlist")[0].reset(),$("#formCreate_watched")[0].reset(),$("#formCreate_rewatch")[0].reset(),$("#watchedPlaceholder").val(""),$("#linkPlaceholder").val(""),$("#seasonPlaceholder").val(""),$("#episodePlaceholder").val("")}function onChange(){var e=$("#watchedPlaceholder"),t=$("#linkPlaceholder"),a=$("#seasonPlaceholder"),l=$("#episodePlaceholder"),i=$("#watched"),r=$("#watched_watched"),o=$("#watched_rewatch"),s=$("#link"),c=$("#link_watched"),n=$("#link_rewatch"),d=$("#season"),h=$("#season_watched"),v=$("#season_rewatch"),m=$("#episode"),u=$("#episode_watched"),p=$("#episode_rewatch");i.val(e.val()),r.val(e.val()),o.val(e.val()),s.val(t.val()),c.val(t.val()),n.val(t.val()),d.val(a.val()),h.val(a.val()),v.val(a.val()),m.val(l.val()),u.val(l.val()),p.val(l.val())}function removeAPI(){localStorage.removeItem("api_film"),localStorage.removeItem("api_serie")}$(window).load(function(){getStorageAPI(),$("#btnRetrieve_watchlist").click(),$("#btnRetrieve_watched").click()}),$("#formCreate_watchlist").submit(function(e){request&&request.abort();var t=$(this),a=t.find("input, select, button, textarea"),t=t.serialize();a.prop("disabled",!0),$("#resultSubmit_watchlist").addClass("show"),(request=$.ajax({url:APP_URL,type:"post",data:t})).done(function(e,t,a){MicroModal.close("modalWatchlist"),$("#modalWatchlist-title").text(""),$("#resultSubmit_watchlist").removeClass("show"),resetForm(),$("#btnRetrieve_watchlist").click()}),request.fail(function(e,t,a){console.error("The following error occured: "+t,a)}),request.always(function(){a.prop("disabled",!1)}),e.preventDefault()}),$("#formCreate_watched").submit(function(e){request&&request.abort();var t=$(this),a=t.find("input, select, button, textarea"),t=t.serialize();a.prop("disabled",!0),$("#resultSubmit_watched").addClass("show"),(request=$.ajax({url:APP_URL,type:"post",data:t})).done(function(e,t,a){MicroModal.close("modalWatchlist"),$("#modalWatchlist-title").text(""),$("#resultSubmit_watched").removeClass("show"),resetForm(),$("#btnRetrieve_watched").click()}),request.fail(function(e,t,a){console.error("The following error occured: "+t,a)}),request.always(function(){a.prop("disabled",!1)}),e.preventDefault()}),$("#formCreate_rewatch").submit(function(e){request&&request.abort();var t=$(this),a=t.find("input, select, button, textarea"),t=t.serialize();a.prop("disabled",!0),$("#resultSubmit_rewatch").addClass("show"),(request=$.ajax({url:APP_URL,type:"post",data:t})).done(function(e,t,a){MicroModal.close("modalWatchlist"),$("#modalWatchlist-title").text(""),$("#resultSubmit_rewatch").removeClass("show"),resetForm(),$("#btnRetrieve_rewatch").click()}),request.fail(function(e,t,a){console.error("The following error occured: "+t,a)}),request.always(function(){a.prop("disabled",!1)}),e.preventDefault()}),$("#formRetrieve_watchlist").submit(function(e){var t=$(this),a=t.find("input, select, button, textarea"),t=t.serialize();a.prop("disabled",!0),(request=$.ajax({url:APP_URL,type:"post",data:t})).done(function(e,t,a){e=e.values;$.each(e,function(e,t){0==e||$("#"+t[1]).addClass("movie--toWatch")})}),request.fail(function(e,t,a){console.error("The following error occured: "+t,a)}),request.always(function(){a.prop("disabled",!1)}),e.preventDefault()}),$("#formRetrieve_watched").submit(function(e){var t=$(this),a=t.find("input, select, button, textarea"),t=t.serialize();a.prop("disabled",!0),(request=$.ajax({url:APP_URL,type:"post",data:t})).done(function(e,t,a){e=e.values;$.each(e,function(e,t){0==e||$("#"+t[1]).addClass("movie--watched")}),$("#loading").addClass("hide")}),request.fail(function(e,t,a){console.error("The following error occured: "+t,a)}),request.always(function(){a.prop("disabled",!1)}),e.preventDefault()}),$("#formRetrieve_rewatch").submit(function(e){var t=$(this),a=t.find("input, select, button, textarea"),t=t.serialize();a.prop("disabled",!0),(request=$.ajax({url:APP_URL,type:"post",data:t})).done(function(e,t,a){e=e.values;$.each(e,function(e,t){})}),request.fail(function(e,t,a){console.error("The following error occured: "+t,a)}),request.always(function(){a.prop("disabled",!1)}),e.preventDefault()}),$("#watchedPlaceholder").change(onChange).keyup(onChange),$("#linkPlaceholder").change(onChange).keyup(onChange),$("#seasonPlaceholder").change(onChange).keyup(onChange),$("#episodePlaceholder").change(onChange).keyup(onChange),$("#modalLogout-logout").click(function(){removeAPI(),$("#username").val(""),$("#password").val(""),MicroModal.close("modalLogout"),setTimeout(function(){var e=window.location.origin;window.location.replace(e+"/WatchApp")},500)}),$("#logout").click(function(){MicroModal.show("modalLogout")}),$("#modalLogout-close").click(function(){MicroModal.close("modalLogout")}),$("#modalLogout-cancel").click(function(){MicroModal.close("modalLogout")});
